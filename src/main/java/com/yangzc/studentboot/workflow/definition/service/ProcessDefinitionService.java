package com.yangzc.studentboot.workflow.definition.service;
...
public class ProcessDefinitionService {
    ...
    public void startProcess(String assignee) {
        // 从系统用户表中查询用户信息
        UserDO user = userMapper.selectUserByLoginName(assignee);
        Map<String, Object> variables = new HashMap<>();
        variables.put("sysUser", user);
...
//        runtimeService.startProcessInstanceByKey("oneTaskProcess");
     ...
     * @return
     */
    public Page<com.yangzc.studentboot.workflow.definition.domain.ProcessDefinition> listProcessDefinition(com.yangzc.studentboot.workflow.definition.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.yangzc.studentboot.workflow.definition.domain.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition: processDefinitionList) {
            com.yangzc.studentboot.workflow.definition.domain.ProcessDefinition entity = new com.yangzc.studentboot.workflow.definition.domain.ProcessDefinition();
